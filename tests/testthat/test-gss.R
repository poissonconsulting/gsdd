...
test_that("gss works shortened", {
  ...
  expect_message(
    gss <- gss(data, min_length = 100, end_date = as.Date("1972-09-29")),
...
test_that("gss truncation both ends", {
  ...
  data$temperature[data$date >= as.Date("2019-08-28")] <- 5
  data <- data[
    data$date >= as.Date("2019-03-02") & data$date <= as.Date("2019-11-29"),
  ]
