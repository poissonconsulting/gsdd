...
test_that("growth_trapezoid_factory works", {
  ...
  expect_equal(trapezoid_growth(c(1:20)), c(0, 0, 0, 0, 0.166666666666667, 0.333333333333333, 0.5, 0.666666666666667, 
...
test_that("growth_trapezoid_factory as triangle", {
  ...
  expect_equal(triangle_growth(c(1:14)), c(0, 0, 0, 0, 0.166666666666667, 0.333333333333333, 0.5, 0.666666666666667, 
