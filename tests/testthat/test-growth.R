test_that("growth_degdays works", {
  ...
  expect_identical(growth_degdays(c(-1:20), Tmin = 2), c(0, 0, 0, 0, 3:20))
})

test_that("growth_days works", {
  expect_identical(growth_days(-1), 0)
  expect_identical(growth_days(0), 0)
  expect_identical(growth_days(0.5), 1)
  expect_identical(growth_days(1), 1)
  expect_identical(growth_days(c(2, 1)), c(1, 1))
  expect_identical(growth_days(c(-1:20)), c(0, 0, rep(1, 20)))
  expect_identical(growth_days(c(-1:20), Tmin = 2), c(0, 0, 0, 0, rep(1, 18)))
})
