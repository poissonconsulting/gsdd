test_that("date_atus works", {
  date_atus <- date_atus(temperature_data)
  expect_snapshot({
    date_atus
  })
})
# 
# test_that("date_atus before leap year", {
#   date_atus <- date_atus(temperature_data, start_date = as.Date("1972-02-28"))
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus shifts by 10", {
#   data <- temperature_data
#   data <- data[-(1:10),]
#   date_atus <- date_atus(data, min_length = 100)
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus preserves if shift start date", {
#   data <- temperature_data
#   data <- data[-(1:10),]
...
# })
# 
# test_that("date_atus preserves if shift before leap year", {
#   data <- temperature_data
#   data <- data[-(1:10),]
...
# })
# 
# test_that("date_atus preserves if shift after leap", {
#   data <- temperature_data
#   data <- data[-(1:10),]
...
# 
# test_that("date_atus preserves if shift start date", {
#   date_atus <- date_atus(temperature_data, start_date = as.Date("2019-03-20"), ignore_truncation = TRUE)
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus one message", {
#   data <- temperature_data
#   data <- data[-(1:100),]
#   expect_message(date_atus <- date_atus(data, min_length = 100), "The growing season is truncated at the start of the sequence.")
#   expect_snapshot({
#     date_atus
#   })
# })
...
# 
# test_that("date_atus works", {
#   date_atus <- date_atus(temperature_data, window_width = 13)
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus works shortened", {
#   data <- temperature_data
#   data <- data[data$date <= as.Date("2019-09-28"),]
#   expect_message(date_atus <- date_atus(data, min_length = 100, end_date = as.Date("1972-09-29")),
...
# })
# 
# test_that("date_atus works shortened truncated", {
#   data <- temperature_data
#   data <- data[data$date <= as.Date("2019-09-28"),]
#   date_atus <- date_atus(data, min_length = 100, end_date = as.Date("1972-09-29"), ignore_truncation = "end")
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus NA if stops before", {
#   data <- temperature_data
#   data <- data[data$date < as.Date("2019-09-30"),]
#   expect_message(date_atus <- date_atus(data))
#   expect_snapshot({
#     date_atus
#   })
# })
...
#   date_atus <- date_atus(data, window_width = 3, start_temp = 9, end_temp = 9)
#   expect_snapshot({
#     date_atus
#   })
# })
...
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, start_date = as.Date("1972-01-02"))
#   expect_snapshot({
#     date_atus
#   })
# })
...
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, start_date = as.Date("1972-02-28"))
#   expect_snapshot({
#     date_atus
#   })
# })
...
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, start_date = as.Date("1972-03-02"))
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus biggest", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, pick = "biggest")
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus smallest", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, pick = "smallest")
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus longest", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, pick = "longest")
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus shortest", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, pick = "shortest")
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus first", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, pick = "first")
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus last", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   date_atus <- date_atus(data, pick = "last")
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus truncation start", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   data$temperature[data$date <= as.Date("2019-04-11")] <- 6
#   data <- data[data$date >= as.Date("2019-03-02"),]
#   date_atus <- date_atus(data, ignore_truncation =TRUE)
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus truncation end", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
...
# })
# 
# test_that("date_atus truncation both ends", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   data$temperature[data$date <= as.Date("2019-04-11")] <- 6
#   data$temperature[data$date >= as.Date("2019-08-28")] <- 5
#   data <- data[data$date >= as.Date("2019-03-02") & data$date <= as.Date("2019-11-29"),]
#   date_atus <- date_atus(data, min_length = 100, ignore_truncation =TRUE)
#   expect_snapshot({
#     date_atus
#   })
# })
# 
# test_that("date_atus truncation all", {
#   data <- gsdd::temperature_data
#   data$temperature <- data$temperature2
#   data$temperature <- 6
#   data <- data[data$date >= as.Date("2019-03-02") & data$date <= as.Date("2019-11-29"),]
...
#   
#   date_atus <- date_atus(data, min_length = 60)
#   
#   expect_snapshot({
#     date_atus
#   })
#   
#   date_atus_plot(data, min_length = 60)
# })
# 
# test_that("date_atus above from start to finish", {
#   data <- gsdd::temperature_data
#   data$temperature <- 6
#   date_atus <- date_atus(data)
#   expect_snapshot({
...
# })
# 
# test_that("date_atus truncated if missing", {
#   data <- gsdd::temperature_data
#   data <- data[data$date >= as.Date("2019-03-02"),]
#   data$temperature <- 6
#   expect_message(date_atus <- date_atus(data), "The growing season is truncated at the start of the sequence.")
#   expect_snapshot({
#     date_atus
#   })
# })
