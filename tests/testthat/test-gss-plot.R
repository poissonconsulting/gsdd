...
test_that("gss_plot wrap cut year", {
  expect_snapshot_plot(
    gss_plot(
      ...
      start_date = as.Date("1972-06-01"),
      end_date = as.Date("1972-11-01"),
      min_length = 120
    ),
    "gss_plot8"
  )
...
test_that("gss_plot starts above 5", {
  ...
  data <- data[-(1:85), ]
  expect_snapshot_plot(
    gss_plot(data, min_length = 60, ignore_truncation = TRUE),
    "gss_plot13"
  )
})
